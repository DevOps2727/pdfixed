<?php $__env->startSection('meta_description', 'Meet the editor behind Pdfixed — experience, tooling, and a process built for dependable PDF delivery.'); ?>
        ...
        <div class="mx-auto max-w-4xl space-y-10 px-4 text-sm leading-relaxed text-slate-700 dark:text-slate-200 sm:px-6 lg:px-8">
            ...
            <div>
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2">
                    ...
                    ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><?php \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::startLoopIteration(); ?><?php endif; ?>
            ...
            <div class="rounded-3xl border border-slate-200 bg-gradient-to-br from-pdf-navy to-pdf-navy-deep p-8 text-white dark:border-white/10">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="mt-6 inline-flex rounded-xl bg-pdf-cyan px-5 py-2.5 text-sm font-semibold text-white transition hover:brightness-110">
                    Contact me
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.pdfforge', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/ahmad-fraza/pdfix/pdfixed/resources/views/pages/about.blade.php ENDPATH**/ ?>