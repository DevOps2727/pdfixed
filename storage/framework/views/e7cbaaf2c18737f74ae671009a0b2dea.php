...
<article class="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm dark:border-white/10 dark:bg-white/5">
    ...
    <p class="mt-4 text-sm leading-relaxed text-slate-700 dark:text-slate-200">“<?php echo e($quote); ?>”</p>
    <div class="mt-5 text-sm">
        <div class="font-semibold text-slate-900 dark:text-white"><?php echo e($name); ?></div>
        <div class="text-slate-500 dark:text-slate-400"><?php echo e($role); ?></div>
    </div>
</article>
<?php /**PATH /home/ahmad-fraza/pdfix/pdfixed/resources/views/components/testimonial-card.blade.php ENDPATH**/ ?>